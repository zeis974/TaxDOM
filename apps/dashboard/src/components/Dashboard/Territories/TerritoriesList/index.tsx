...
import { Container, NoTerritories, TerritoriesContainer } from "./TerritoriesList.styled"

interface TerritoriesListProps {
  territories: Territory[]
}

export default function TerritoriesList({ territories }: TerritoriesListProps) {
    ...
    return (
      <Container>
        <NoTerritories>
          ...
          <p>Ajoutez votre premier territoire en cliquant sur le bouton ci-dessus.</p>
        </NoTerritories>
      </Container>
    )
  }
